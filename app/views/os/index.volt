...
<div class="panel panel-default">
	...
	<div id="collapseThree" class="panel-collapse collapse" style="height: auto;">
		<div class="panel-body">
			{{ form('/backend_app/os/', 'method': 'get', 'enctype': 'multipart/form-data') }}
...
<span class="pull-right" style="margin-right:14px;margin-bottom:14px;">
	<a href="/backend_app/os/new/"><i class="fa fa-link" aria-hidden="true"></i>&nbsp;新規登録はこちら</a>
</span>
		...
		{% if os is not empty %}
			...
			{% endif %}
					<tr>
						...
						<td class="col-md-1">
							{{ form('backend_app/os/edit?id=' ~ os.id ~ '/', 'method': 'post') }}
						...
						<td class="col-md-1">
							{{ form('backend_app/os/delete?id=' ~ os.id ~ '/', 'method': 'post', 'onSubmit': 'return delete_check()') }}
